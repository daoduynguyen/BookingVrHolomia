...
<body class="bg-light text-dark ticket-detail-page">
    ...
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <a href="{{ route('branch.home', ['subdomain' => $subdomain]) }}" class="btn btn-outline-secondary btn-sm"><i class="bi bi-arrow-left"></i> Quay
                lại</a>
        </div>
                    ...
                    <div class="text-center mb-4">
                        ...
                        <div class="d-flex align-items-center justify-content-center gap-3 text-muted">
                            <span class="d-flex align-items-center gap-1">
                                <i class="bi bi-geo-alt-fill text-danger"></i> Chi nhánh {{ $location->name }}
                            </span>
