...
<head>
    ...
    <title>{{ __('auth.register_title') }} - {{ $location->name }}</title>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .step-num {
            ...
            border: 1px solid {{ $location->color ?? '#00c8ff' }};
            display: flex;
            align-items: center;
            justify-content: center;
            font-size: 0.8rem;
            font-weight: 600;
            color: {{ $location->color ?? '#00c8ff' }};
            flex-shrink: 0;
        }
        ...
        .form-control:focus { border-color: {{ $location->color ?? '#0055c4' }}; background: #fff; box-shadow: none; }
        ...
        /* Thêm style cho các nút social login */
        .btn-social {
            display: flex;
            align-items: center;
            justify-content: center;
...
<body>
    ...
    <div class="left-panel">
        ...
        <div class="brand-content">
            ...
            <div class="brand-tagline">Khám phá vũ trụ ảo tại chi nhánh {{ $location->name }}</div>
    ...
    <div class="right-panel">
        <div class="form-wrapper">
            ...
            <div class="form-header text-center mb-4">
                ...
                <p class="text-muted mt-2">Đăng ký thành viên tại cơ sở {{ $location->name }}</p>
            </div>
            ...
            <form action="{{ route('branch.register.post', ['subdomain' => $subdomain]) }}" method="POST">
                @csrf
                ...
                <div class="text-center" style="font-size:0.9rem;">
                    ...
                    <a href="{{ route('branch.login', ['subdomain' => $subdomain]) }}" class="link-blue ms-1">{{ __('auth.login_now') }}</a>
                </div>
