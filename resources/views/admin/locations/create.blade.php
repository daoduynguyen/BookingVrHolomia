    ...
    <form action="{{ route('admin.locations.update', $location->id) }}" method="POST">
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="hotline" class="form-control" value="{{ old('hotline', $location->hotline) }}"
                    required>
            </div>
            <div class="col-md-6">
                <label class="form-label fw-bold">Giờ Mở Cửa</label>
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-12">
                ...
                <img src="{{ $location->banner_image }}" class="mt-2 rounded"
                    style="max-height:80px; object-fit:cover; max-width:100%;">
                @endif
            </div>
            <div class="col-12">
                <label class="form-label fw-bold">Google Maps Embed</label>
                <textarea name="maps_url" class="form-control"
                    rows="2">{{ old('maps_url', $location->maps_url) }}</textarea>
            </div>
        </div>

        <hr class="my-4">
        <div class="form-check form-switch mb-4">
            <input class="form-check-input" type="checkbox" name="is_active" id="isActive" value="1" {{ old('is_active',
