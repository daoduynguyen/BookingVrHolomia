        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="opening_hours" class="form-control"
                       value="{{ old('opening_hours') }}" placeholder="09:00 – 22:00 mỗi ngày">
            </div>
            <div class="col-md-6">
                <label class="form-label fw-bold">Facebook Fanpage</label>
                <input type="url" name="facebook_url" class="form-control"
                       value="{{ old('facebook_url') }}" placeholder="https://facebook.com/holomia.hanoi">
            </div>
        </div>
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-12">
                ...
                <input type="url" name="banner_image" class="form-control @error('banner_image') is-invalid @enderror"
                       ...
                       placeholder="https://example.com/banner-hanoi.jpg">
                @error('banner_image') <div class="invalid-feedback">{{ $message }}</div> @enderror
                <div class="form-text">Kích thước khuyến nghị: 1920×600px. Dùng URL ảnh đã upload lên CDN.</div>
            </div>
            <div class="col-12">
                <label class="form-label fw-bold">Google Maps Embed URL</label>
                <textarea name="maps_url" class="form-control" rows="2"
                          placeholder='<iframe src="https://maps.google.com/..." ...></iframe>'>{{ old('maps_url') }}</textarea>
                <div class="form-text">Dán toàn bộ thẻ &lt;iframe&gt; từ Google Maps vào đây.</div>
            </div>
        </div>
...
{{-- ─────────────────────────────────────────────────────────────
     resources/views/admin/locations/edit.blade.php  (Phase 1)
───────────────────────────────────────────────────────────────── --}}

{{--
COPY FILE edit.blade.php RIÊNG, dán nội dung sau:
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <small class="text-muted">
            Landing page:
            <a href="{{ route('location.landing', $location->slug) }}" target="_blank"
               class="text-primary">
    ...
    <form action="{{ route('admin.locations.update', $location->id) }}" method="POST">
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="hotline" class="form-control" value="{{ old('hotline', $location->hotline) }}" required>
            </div>
            <div class="col-md-6">
                <label class="form-label fw-bold">Giờ Mở Cửa</label>
            ...
            <div class="col-md-6">
                <label class="form-label fw-bold">Facebook Fanpage</label>
                <input type="url" name="facebook_url" class="form-control" value="{{ old('facebook_url', $location->facebook_url) }}">
            </div>
        </div>
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-12">
                <label class="form-label fw-bold">URL Ảnh Banner</label>
                <input type="url" name="banner_image" class="form-control" value="{{ old('banner_image', $location->banner_image) }}">
                @if($location->banner_image)
                    <img src="{{ $location->banner_image }}" class="mt-2 rounded" style="max-height:80px; object-fit:cover; max-width:100%;">
                @endif
            </div>
            <div class="col-12">
                <label class="form-label fw-bold">Google Maps Embed</label>
                <textarea name="maps_url" class="form-control" rows="2">{{ old('maps_url', $location->maps_url) }}</textarea>
            </div>
        </div>
        ...
        <div class="form-check form-switch mb-4">
            ...
            <label class="form-check-label fw-bold" for="isActive">Hiển thị landing page cơ sở này</label>
        </div>
