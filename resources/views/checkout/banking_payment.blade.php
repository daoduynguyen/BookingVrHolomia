...
<head>
    <meta charset="UTF-8">
    <title>Thanh toán chuyển khoản - Holomia VR</title>
                ...
                <div class="card border-0 shadow-sm rounded-4 p-4">
                    ...
                    <div class="bg-light rounded-3 p-3 mb-3 small">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <span class="fw-bold text-end" style="max-width:55%;">{{ $order->location->name }}</span>
                        </div>
                        @endif
                    </div>
            ...
            <div class="col-lg-8">
                <div class="card border-0 shadow-sm rounded-4 p-4 text-center">
                    ...
                    <div id="btn-view-order" class="{{ $order->status == 'paid' ? '' : 'd-none' }} mt-3">
                        <a href="{{ route('profile.index') }}" class="btn btn-success fw-bold rounded-pill px-4">
